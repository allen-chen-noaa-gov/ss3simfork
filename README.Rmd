...
documentation and the original repository. This readme outlines chhanges to 
that original repository.
...
included below. The ggplot2, RColorBrewer, doParallel, and foreach packages can 
be found on CRAN. Please get ss3simfork and barebones.FishSET from their 
...
An example econ file is shown below. The econ case file specifies the economic 
model and sampling process in `functionname`. There are currently four options: 
...
indices will be written to the speciifed folder and name, ending in the ss3sim 
...
![Spawning biomass output example](https://raw.github.com/allen-chen-noaa/ss3simfork/master/inst/extdata/econ/SB_081821_mortup4.png)
...
![Abundance indices output example](https://raw.github.com/allen-chen-noaa/ss3simfork/master/inst/extdata/econ/abundline_081821_mortup4.png
