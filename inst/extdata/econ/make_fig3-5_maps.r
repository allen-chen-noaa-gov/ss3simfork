...
fig3out <- ggarrange(base, singlestart, ncol = 2, nrow = 1,
  common.legend = TRUE)

ggsave(fig3out, file = paste0(getwd(),
...
fig4out <- ggarrange(random1, random2, ncol = 2, nrow = 1,
  common.legend = TRUE)

ggsave(fig4out, file = paste0(getwd(),
...
fig5out <- ggarrange(trendsave[[1]], trendsave[[5]], trendsave[[9]],
  trendsave[[13]], ncol = 2, nrow = 2, common.legend = TRUE)

ggsave(fig5out, file = paste0(getwd(),
