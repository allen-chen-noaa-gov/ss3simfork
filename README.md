...
chhanges to that original repository.
...
inst-cases folder in the package, to be copied into the directory you
chose above.

An example econ file is shown below. The econ case file specifies the
economic model and sampling process in `functionname`. There are
...
specify a file name, abundance indices will be written to the speciifed
...
example](https://raw.github.com/allen-chen-noaa/ss3simfork/master/inst/extdata/econ/SB_081821_mortup4.png)

We can also look at the relative abundance indices across different
sampling patterns.

``` r
#I saved my abundance indices to my raw output directory. This could be 
...
example\](<a href="https://raw.github.com/allen-chen-noaa/ss3simfork/master/inst/extdata/econ/abundline_081821_mortup4.png" class="uri">https://raw.github.com/allen-chen-noaa/ss3simfork/master/inst/extdata/econ/abundline_081821_mortup4.png</a>
